  ...
  class JobAdItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SmartRecruiters::JobAdItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SmartRecruiters::JobAdItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'apply_url')
        self.apply_url = attributes[:'apply_url']
      end
    ...
    def list_invalid_properties
      ...
      if @job_ad.nil?
        invalid_properties.push('invalid value for "job_ad", job_ad cannot be nil.')
      end
      ...
      if @updated_on.nil?
        invalid_properties.push('invalid value for "updated_on", updated_on cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @job_ad.nil?
      return false if @created_on.nil?
      return false if @updated_on.nil?
      return false if @posting_status.nil?
      posting_status_validator = EnumAttributeValidator.new('Object', ['PUBLISHED', 'NOT_PUBLISHED'])
      ...
      visibility_validator = EnumAttributeValidator.new('Object', ['PUBLIC', 'INTERNAL', 'PRIVATE'])
    ...
    def posting_status=(posting_status)
      validator = EnumAttributeValidator.new('Object', ['PUBLISHED', 'NOT_PUBLISHED'])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('Object', ['PUBLIC', 'INTERNAL', 'PRIVATE'])
    ...
    def hash
      [id, title, language, job_ad, created_on, updated_on, apply_url, posting_status, default, actions, creator, visibility].hash
    end
